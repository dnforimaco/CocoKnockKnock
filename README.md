...
- **Firebase Integration**: Cloud-based authentication and data storage
- **Local Storage**: Offline-capable data persistence

### 🔐 User Authentication
- **Secure Login**: Firebase-powered user authentication
- **Account Management**: Create account, password reset, secure sessions
...
This project is licensed under the 0BSD License - see the [package.json](package.json) file for details.
